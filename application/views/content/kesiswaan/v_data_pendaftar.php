<body>
    <div class="col-md-10">
        <div class="container">
            ...
            <?php echo form_open('c_verifpendaftaran/verifMurid'); ?>
            <div class="tab-content">
                <div id="home" class="tab-pane fade in active">
                    ...
                    <?php if ($vmurid) {
                        ...
                        if ($vmurid->verif == 1) { ?>
                        	<input type="radio" name="verif_murid" value="0"> Belum Verifikasi
                        	<input type="radio" name="verif_murid" value="1" checked> Sudah Verifikasi
                        <?php }elseif ($vmurid->verif == 0) { ?>
                        	<input type="radio" name="verif_murid" value="0" checked> Belum Verifikasi
                        	<input type="radio" name="verif_murid" value="1"> Sudah Verifikasi
                        <?php }
                    ...
                    <?php } ?>
                    <br>
                    <textarea name="keterangan_murid"><?php echo $vmurid->keterangan; ?></textarea>
                </div>
                    ...
                    <?php
                        if ($vwalimurid) {
                            if ($vwalimurid->verif == 1) { ?>
                                <input type="radio" name="verif_wali" value="0"> Belum Verifikasi
                                <input type="radio" name="verif_wali" value="1" checked> Sudah Verifikasi
                            <?php }elseif ($vwalimurid->verif == 0) { ?>
                                <input type="radio" name="verif_wali" value="0" checked> Belum Verifikasi
                                <input type="radio" name="verif_wali" value="1"> Sudah Verifikasi
                            <?php }
                        }else{ ?>
                            <input type="radio" name="verif_wali" value="0"> Belum Verifikasi
                            <input type="radio" name="verif_wali" value="1"> Sudah Verifikasi
                        <?php } ?>
                        <br>
                        <textarea name="keterangan_wali"><?php echo $vwalimurid->keterangan; ?></textarea>
                </div>
                ...
                <div id="menu2" class="tab-pane fade">
                    ...
                    <?php
                        if ($vdokumen) {
                            if ($vdokumen->verif == 1) { ?>
                                <input type="radio" name="verif_dok" value="0"> Belum Verifikasi
                                <input type="radio" name="verif_dok" value="1" checked> Sudah Verifikasi
                            <?php }elseif ($vdokumen->verif == 0) { ?>
                                <input type="radio" name="verif_dok" value="0" checked> Belum Verifikasi
                                <input type="radio" name="verif_dok" value="1"> Sudah Verifikasi
                            <?php }
                        }else{ ?>
                            <input type="radio" name="verif_dok" value="0"> Belum Verifikasi
                            <input type="radio" name="verif_dok" value="1"> Sudah Verifikasi
                        <?php } ?>
                        <br>
                        <textarea name="keterangan_dok"><?php echo $vdokumen->keterangan ?></textarea>
                </div>
            </div>
